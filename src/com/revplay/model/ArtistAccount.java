...
public class ArtistAccount {
    ...
    public ArtistAccount(int artistId, String stageName, String genre) {
        this.artistId = artistId;
        this.stageName = stageName;
        this.genre = genre;
    }

    public ArtistAccount(int artistId, String stageName, String email, String passwordHash,
                         String bio, String genre, String instagramLink,
                         String youtubeLink, String spotifyLink,
